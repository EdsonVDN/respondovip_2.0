...
const useStyles = makeStyles((theme) => ({
  ...
  card0: {
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#4DA1D1 ", //conexões ativas
    color: "#eee",
  },
  card00: {
    padding: theme.spacing(2),
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#4DA1D1 ", //empresas
    color: "#eee",
  },
  card1: {
    padding: theme.spacing(2),
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#4DA1D1 ", //conversas
    color: "#eee",
  },
  card2: {
    padding: theme.spacing(2),
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#4DA1D1 ", //aguardando
    color: "#eee",
  },
  card3: {
    padding: theme.spacing(2),
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#4DA1D1 ", //finalizados
    color: "#eee",
  },
  card4: {
    padding: theme.spacing(2),
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#4DA1D1 ", //novos contatos
    color: "#eee",
  },
  card5: {
    padding: theme.spacing(2),
  ...
  card8: {
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#4DA1D1 ", //tempo media de conversa
    color: "#eee",
  },
  card9: {
    padding: theme.spacing(2),
    ...
    flexDirection: "column",
    height: "100%",
    backgroundColor: "#4DA1D1 ", //tempo de espera #cc991b
    color: "#eee",
  },
  fixedHeightPaper2: {
    padding: theme.spacing(2),
